...
import 'package:job_search/modelgen/desiredjobtypes.g.dart';
import 'package:job_search/modelgen/filteredresults.g.dart';
import 'package:job_search/modelgen/skillList.g.dart';
import 'package:job_search/modelgen/skilldata.g.dart';
import 'package:supabase_flutter/supabase_flutter.dart';
import 'package:job_search/modelgen/popularsearches.g.dart';
...
Future<List<Companies>> getPopularCompanyData() async {

  final supabase = Supabase.instance.client;
  
  final response = await supabase.from('companies').select();

  final List<Companies> tableModel =
      response.map((item) => Companies.fromMap(item)).toList();
...
Future<List<Skilldata>> getSkillsData() async {

  final supabase = Supabase.instance.client;
  
  final response = await supabase.from('skilldata').select();

  final List<Skilldata> tableModel =
      response.map((item) => Skilldata.fromMap(item)).toList();
...
Future<List<Drawerlist1>> getDrawerList1() async {

  final supabase = Supabase.instance.client;
  
  final response = await supabase.from('drawerlist1').select();

  final List<Drawerlist1> tableModel =
      response.map((item) => Drawerlist1.fromMap(item)).toList();
...
Future<List<Drawerlist2>> getDrawerList2() async {

  final supabase = Supabase.instance.client;
  
  final response = await supabase.from('drawerlist2').select();

  final List<Drawerlist2> tableModel =
      response.map((item) => Drawerlist2.fromMap(item)).toList();
...
Future<List<Popularsearches>> getPopularSearchList() async {

  final supabase = Supabase.instance.client;
  
  final response = await supabase.from('popularsearches').select();

  final List<Popularsearches> tableModel =
      response.map((item) => Popularsearches.fromMap(item)).toList();
...
Future<List<Filteredresults>> getFilteredResultsData() async {

  final supabase = Supabase.instance.client;
  
  final response = await supabase.from('filteredresults').select();

  final List<Filteredresults> tableModel =
      response.map((item) => Filteredresults.fromMap(item)).toList();
...
Future<List<SkillList>> getSkillsList() async {

  final supabase = Supabase.instance.client;
  
  final response = await supabase.from('skillList').select();

  final List<SkillList> tableModel =
      response.map((item) => SkillList.fromMap(item)).toList();
...
Future<List<RemoveJobs>> getRemoveJobsList() async {

  final supabase = Supabase.instance.client;
  
  final response = await supabase.from('removejobs').select();

  final List<RemoveJobs> tableModel =
      response.map((item) => RemoveJobs.fromMap(item)).toList();
...
Future<List<Remote>> getRemoteList() async {

  final supabase = Supabase.instance.client;
  
  final response = await supabase.from('remote').select();

  final List<Remote> tableModel =
      response.map((item) => Remote.fromMap(item)).toList();
...
Future<List<Sortbyoptions>> getSortByList() async {

  final supabase = Supabase.instance.client;
  
  final response = await supabase.from('sortbyoptions').select();

  final List<Sortbyoptions> tableModel =
      response.map((item) => Sortbyoptions.fromMap(item)).toList();
...
Future<List<Datepostedoptions>> getDatePostedList() async {

  final supabase = Supabase.instance.client;
  
  final response = await supabase.from('datepostedoptions').select();

  final List<Datepostedoptions> tableModel =
      response.map((item) => Datepostedoptions.fromMap(item)).toList();
...
Future<List<Desiredjobtypes>> getDesireJobTypeList() async {

  final supabase = Supabase.instance.client;
  
  final response = await supabase.from('desiredjobtypes').select();

  final List<Desiredjobtypes> tableModel =
      response.map((item) => Desiredjobtypes.fromMap(item)).toList();
