        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  RatingBar(
                    ...
                    onRatingUpdate: (rating) {}, ratingWidget: null,
                  ),
                ],
              ),
              8.height,
              ...
              Row(
                children: [
                  Text("assistant branch manager", style: secondaryTextStyle(decoration: TextDecoration.underline)),
                  Text("(Current Employee)-", style: secondaryTextStyle(decoration: TextDecoration.underline)),
                  Text("East", style: secondaryTextStyle(decoration: TextDecoration.underline)),
                ],
              ),
              8.height,
              Row(
                children: [
                  Text("London, Greater London", style: secondaryTextStyle(decoration: TextDecoration.underline)),
                  Text("26 June 2021", style: secondaryTextStyle(decoration: TextDecoration.underline)),
                ],
              ),
              16.height,
              Container(
